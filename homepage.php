...
<!-- Mirrored from creativelayers.net/themes/freeio-html/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2023 04:53:00 GMT -->
<head>
<meta charset="utf-8">
...
<div class="wrapper ovh">
        ...
        <div class="row align-items-center justify-content-between">
          <div class="col-auto px-0 px-xl-3">
            <div class="d-flex align-items-center justify-content-between">
              <div class="logos">
                <a class="header-logo logo1" href=""><img src="images/header-logo.svg" alt="Header Logo"></a>
                <a class="header-logo logo2" href=""><img src="images/header-logo2.svg" alt="Header Logo"></a>
              </div>
          ...
          <div class="col-auto pe-0 pe-xl-3">
            <div class="d-flex align-items-center">
              ...
              <a class="login-info mx15-xl mx30" href="sellerreq.php"><span class="d-none d-xl-inline-block"></span> </a>
              <a class="login-info mr15-xl mr30" href="reg.php">Sign in</a>
              <a class="ud-btn btn-white add-joining bdrs50 text-thm2" href="login.php">Join</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <ul>
        ...
        <li><span>Users</span>
          <ul>
            ...
            <li><a href="page-become-seller.html"></li>
          </ul>
        </li>
        <li><span>Pages</span>
          <ul>
  ...
  <div class="body_content">
        ...
        <div class="row mb60 mb0-xl">
          <div class="col-xl-7">
            <div class="pr30 pr0-lg mb30-md position-relative">
              <h1 class="animate-up-1 mb25 text-white">Find the perfect freelance <br class="d-none d-xl-block">services for your business</h1>
              <p class="text-white animate-up-2">Work with talented people at the most affordable price to get the most <br class="d-none d-lg-block"> out of your time and cost</p>
    ...
    <section class="cta-banner-about2 before-none at-home2 position-relative py-0">
      ...
      <img class="home2-cta-img" src="images/about/about-10.jpg" alt="">
    </section>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="text-center text-lg-start">
              <p class="copyright-text mb-0 text-white-light ff-heading"> Freeio. 2023 </p>
            </div>
          </div>
          <div class="col-md-6">
...
<!-- Mirrored from creativelayers.net/themes/freeio-html/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2023 04:53:08 GMT -->
</html>