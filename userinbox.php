...
session_start();
$s=$_SESSION['uname'];
$data=mysqli_query($con,"select * from booking where pstatus='paid' and sstatus='completed' and cuname='$s'");
?>
<body>
        ...
        <div class="row align-items-center justify-content-between">
          ...
          <div class="col-auto">
            <div class="d-flex align-items-center">
              ...
              <a class="login-info mr15-lg mr30" href=""></a>
          ...
          <div class="shopping_cart_table table-responsive">
            <table class="table table-borderless">
              <thead>
                ...
                <tr>
                <th class="pl30" scope="col">Booking No</th>
                  <th class="pl30" scope="col">Service name</th>
                  <th class="ps-0" scope="col">Seller name</th>
                  <th class="ps-0" scope="col">payment status</th>
                  <th class="ps-0" scope="col">Service status</th>
                  <th class="ps-0" scope="col">Price</th>
                  <th class="ps-0" scope="col">Feedback</th>
                  <th scope="col"></th>
                  <?php
              ...
              <tbody class="table_body">
                <tr>
                  ...
                  <div class="cart_list d-flex align-items-center">
                     ...
                     <h5 class="mb-0"><?php echo $res['bkgno'];?></h5>
                   </div>
                   <td>
                    <div class="cart_list d-flex align-items-center">
                     
                      <h5 class="mb-0"><?php echo $res['title'];?></h5>
</td>
                    </div>
                    <td class="pl30 ">
                    <div class="cart_list d-flex align-items-center">
                     
                      <h5 class="mb-0"><?php echo $res['suname'];?></h5>
                    </div>
                  </td>
                  <td class="pl30 ">
                    <div class="cart_list d-flex align-items-center">
                     
                      <h5 class="mb-0"><?php echo $res['pstatus'];?></h5>
                    </div>
                    <td class="pl30 ">
                    <div class="cart_list d-flex align-items-center">
                     
                      <h5 class="mb-0"><?php echo $res['sstatus'];?></h5>
                    </div>
                  
                  <td><div class="cart-price"><?php echo $res['price'];?></div></td>
                   <td class="vam"><span class="pending-style style1"><a href="feedback.php?id=<?php echo $res['bkgno'];?>"><b>Feedback</a></span>
              </td>
...
?>
            ...
            <div class="btn-lsit1">
                  <a href="orders.php" class="ud-btn btn-light-thm">Payments<i class="fal fa-arrow-right-long"></i></a>
                </div>
