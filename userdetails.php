...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-dashboard-invoice.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2023 04:53:55 GMT -->
<head>
<meta charset="utf-8">
...
$data=mysqli_query($con,"select * from free where rights='seller' or rights='user'");
    ...
    <div class="dashboard dashboard_wrapper pr30 pr0-xl">
      <div class="dashboard__sidebar d-none d-lg-block">
        <div class="dashboard_sidebar_list">
          ...
          <div class="sidebar_list_item">
            <a href="userdetails.php" class="items-center -is-active"><i class="flaticon-like mr15"></i>Userdetails</a>
          </div>
          <div class="sidebar_list_item ">
                ...
                <div class="packages_table table-responsive">
                  <table class="table-style3 table at-savesearch">
                    ...
                    <tbody class="t-body">
                      ...
                      ?>
                      <tr>
                        <th scope="row"><?php echo $res['uname'];?></th>
                        <th scope="row"><?php echo $res['emails'];?></th>
                        <td class="vam"><?php echo $res['number'];?></td>
                        <td class="vam"><?php echo $res['rights'];?></td>
                        <td class="vam"><span class="pending-style style1"><a href="terminate.php?id=<?php echo $res['uname'];?>"><b>Terminate</a></span>
              </td>
              <td class="vam"><span class="pending-style style1"><a href="userd.php?id=<?php echo $res['uname'];?>"><b>Edit</a></span>
              </td>
                        </td>
