...
session_start();
$s=$_SESSION['uname'];
$data=mysqli_query($con,"select * from booking where pstatus='please pay' and sstatus='accepted' and cuname='$s'");
?>
<body>
        ...
        <div class="row align-items-center justify-content-between">
          ...
          <div class="col-auto">
            <div class="d-flex align-items-center">
              ...
              <a class="login-info mr15-lg mr30" href="page-login.html"></a>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="main-title">
              <h2 class="title">Order Request</h2>
              <p class="text mb-0"</p>
            </div>
          </div>
        </div>
...
?>
              ...
              <tbody class="table_body">
                <tr>
                  ...
                  <td class="vam"><span class="pending-style style1"><a href="card.php?id=<?php echo $res['bkgno'];?>"><b>payment</a></span>
              </td>
                      </div>
                    </div>
        ...
        <div class="row align-items-center">
          <div class="col-md-6">
            <div class="text-center text-lg-start">
              <p class="copyright-text mb-2 mb-md-0 text-white-light ff-heading">Freeio</p>
            </div>
          </div>
          <div class="col-md-6">
