...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-dashboard-manage-service.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2023 04:53:55 GMT -->
<head>
<meta charset="utf-8">
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                      <div class="user_setting_content">
                        ...
                        <a class="dropdown-item" href="userproposal.php"><i class="flaticon-document mr10"></i>My Proposals</a>
                        ...
                        <a class="dropdown-item" href="sellerreview.php"><i class="flaticon-review-1 mr10"></i>Reviews</a>
                        <a class="dropdown-item" href="page-dashboard-invoice.html"><i class="flaticon-receipt mr10"></i>Invoice</a>
                        <a class="dropdown-item" href="requestbooking.php"><i class="flaticon-dollar mr10"></i>Payouts</a>
                        ...
                        <a class="dropdown-item active" href="page-dashboard-manage-service.html"><i class="flaticon-presentation mr10"></i>Manage Services</a>
      ...
      <div class="dashboard__sidebar d-none d-lg-block">
        <div class="dashboard_sidebar_list">
          ...
          <div class="sidebar_list_item">
            <a href="userdash.php" class="items-center"><i class="flaticon-home mr15"></i>Dashboard</a>
          </div>
          <div class="sidebar_list_item">
            <a href="userproposal.php" class="items-center"><i class="flaticon-document mr15"></i>My Proposals</a>
          </div>
          <div class="sidebar_list_item">
          ...
          <div class="sidebar_list_item ">
            <a href="sellerreview.php" class="items-center"><i class="flaticon-review-1 mr15"></i>Reviews</a>
          </div>
          <div class="sidebar_list_item">
            <a href="page-dashboard-invoice.html" class="items-center"><i class="flaticon-receipt mr15"></i>Invoice</a>
          </div>
          <div class="sidebar_list_item">
            <a href="requestbooking.php" class="items-center"><i class="flaticon-dollar mr15"></i>Payouts</a>
          </div>
          <div class="sidebar_list_item">
          ...
          <div class="sidebar_list_item ">
            <a href="page-dashboard-manage-service.html" class="items-center -is-active"><i class="flaticon-presentation mr15"></i>Manage Services</a>
          </div>
          <div class="sidebar_list_item ">
          ...
          <div class="row pb40">
              ...
              <div class="dashboard_navigationbar d-block d-lg-none">
                <div class="dropdown">
                  ...
                  <ul id="myDropdown" class="dropdown-content">
                    ...
                    <li><a href="userdash.php"><i class="flaticon-home mr10"></i>Dashboard</a></li>
                    ...
                    <li><a href="sellerreview.php"><i class="flaticon-review-1 mr10"></i>Reviews</a></li>
                    <li><a href="page-dashboard-invoice.html"><i class="flaticon-receipt mr10"></i>Invoice</a></li>
                    <li><a href="requestbooking.php"><i class="flaticon-dollar mr10"></i>Payouts</a></li>
                    ...
                    <li class="active"><a href="page-dashboard-manage-service.html"><i class="flaticon-presentation mr10"></i>Manage Services</a></li>
            ...
            <div class="col-lg-3">
              <div class="text-lg-end">
                <a href="gigs.php" class="ud-btn btn-dark default-box-shadow2">Add Service<i class="fal fa-arrow-right-long"></i></a>
              </div>
            </div>
          </div>
          <div class="row">
                ...
                <div class="navtab-style1">
                  <nav>
                    <div class="nav nav-tabs mb30" id="nav-tab2" role="tablist">
                      ...
                      <button class="nav-link fw500" id="nav-item4-tab" data-bs-toggle="tab" data-bs-target="#nav-item4" type="button" role="tab" aria-controls="nav-item4" aria-selected="false">Completed Services</button>
                      <button class="nav-link fw500" id="nav-item5-tab" data-bs-toggle="tab" data-bs-target="#nav-item5" type="button" role="tab" aria-controls="nav-item5" aria-selected="false">Canceled Services</button>
                    </div>
                  </nav>
