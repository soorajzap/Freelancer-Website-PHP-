...
<?php
    ...
    if(isset($_POST['submit']))
    {
      ...
      $mb=$_POST['number'];
      $rpword=$_POST['rpword'];
      $n=mysqli_query ($con,"update free set emails='$em',number='$mb' where uname='$id'");
      if($n>0)
        {
      echo "<script>alert('Edited');window.location.href='Admindash.php';</script>";
        }
      else
        {
       echo "<script>alert('Edited');window.location.href='Admindash.php';</script>";
        ...
        <div class="row wow fadeInRight" data-wow-delay="300ms">
          <div class="col-xl-6 mx-auto">
            ...
            <div class="log-reg-form search-modal form-style1 bgc-white p50 p30-sm default-box-shadow1 bdrs12">
              <div class="mb30">
                <h4>Edit Profile</h4>
                <p class="text mt20"><a href="login.php" class="text-thm"></a></p>
              </div>
              <div class="mb15">
              ...
              <div class="mb15">
                ...
                <input type="text" class="form-control" placeholder="Mob no" name="number">
              </div>
              
              <div class="d-grid mb20">
                <button class="ud-btn btn-thm default-box-shadow2" type="submit" name="submit">Edit<i class="fal fa-arrow-right-long"></i></button>
              </div>
