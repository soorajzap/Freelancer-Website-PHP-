...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2023 15:49:21 GMT -->
<head>
<meta charset="utf-8">
...
<?php
    ...
    session_start();
    $id=$_GET['id'];
    $data=mysqli_query($con,"select * from freelance where id='$id'");
    $result=mysqli_fetch_array($data);
    $tdate=date('Y-m-d');
    $mx=mysqli_query($con,"select max(bkgno)+1 from booking");
    $nxt=mysqli_fetch_array($mx);
    if(empty($nxt[0]))
    { 
      $no=1;
    }
    ...
    if(isset($_POST['submit']))
    {
      ...
      $rdate=$_POST['rdate'];
      $des=$_POST['des'];
      $mdate=date('Y-m-d',strtotime($rdate));
      
       
      $n=mysqli_query ($con,"insert into booking(bkgno,bkgdate,cuname,suname,title,price,rdate,des,pstatus,sstatus) values(' $bkgno','$tdate','$cuname','$suname','$title','$price','$mdate','$des','newreq','newreq')");
      if($n>0)
      {
       
        echo "<script>alert('Booking requested');window.location.href='user.php';</script>";     
      }
      
      else
      {
        echo "<script>alert('booking failed');window.location.href='user.php';</script>";    
      }
        ...
        <div class="row wow fadeInRight" data-wow-delay="300ms">
          ...
          <form method="post">
            <div class="log-reg-form search-modal form-style1 bgc-white p50 p30-sm default-box-shadow1 bdrs12">
              ...
              <div class="mb25">
                <label class="form-label fw500 dark-color">Booking no</label>
                <input type="text" class="form-control" readonly="readonly" value="<?php echo $no;?>" name="bkgno">
              </div>
              <div class="mb25">
                <label class="form-label fw500 dark-color">Booking date</label>
                <input type="text" class="form-control"  readonly="readonly" value="<?php echo $tdate;?>" name="bkgdate">
              </div>
              <div class="mb25">
                <label class="form-label fw500 dark-color">customer name</label>
                <input type="text" class="form-control"  readonly="readonly" value="<?php echo $_SESSION['uname'];?>" name="cuname">
              </div>
              <div class="mb25">
                <label class="form-label fw500 dark-color">seller name</label>
                <input type="text" class="form-control"  readonly="readonly" value="<?php echo $result['uname'];?>" name="suname">
              </div>
              <div class="mb25">
                <label class="form-label fw500 dark-color">service title</label>
                <input type="text" class="form-control"  readonly="readonly" value="<?php echo $result['titile'];?>" name="title">
              </div>
              <div class="mb25">
                <label class="form-label fw500 dark-color">service price</label>
                <input type="text" class="form-control"  readonly="readonly" value="<?php echo $result['price'];?>" name="price">
              </div>
              <div class="mb25">
                <label class="form-label fw500 dark-color">Description/Email</label>
                <input type="text" class="form-control" name="des">
              </div>
              <div class="mb15">
                <label class="form-label fw500 dark-color">Required date</label>
                <input type="date" class="form-control"  name="rdate">
              </div>
              <div class="d-grid mb20">
                <button class="ud-btn btn-thm default-box-shadow2" type="submit" name="submit">Order now<i class="fal fa-arrow-right-long"></i></button>
              </div>
