...
$data=mysqli_query($con,"select * from booking where pstatus='paid' and sstatus='completed'");
?>
<body>
<div class="wrapper">
    ...
    <div class="dashboard dashboard_wrapper pr30 pr0-xl">
      <div class="dashboard__sidebar d-none d-lg-block">
        <div class="dashboard_sidebar_list">
          ...
          <div class="sidebar_list_item ">
            <a href="Adreview.php" class="items-center -is-active"><i class="flaticon-review-1 mr15"></i>Feedback</a>
          </div>
          <div class="sidebar_list_item">
