...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-shop-order.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2023 15:49:20 GMT -->
<head>
<meta charset="utf-8">
        ...
        <div class="row">
          <div class="col-xl-8 offset-xl-2">
            <div class="shop_order_box mt60">
              <div class="order_list_raw">
                <ul class="d-md-flex align-items-center justify-content-md-between p-0 mb-0">
                  <li class="mb20-sm">
                    ...
                    <h6 class="mb-0"><?php echo $rs['bkgno'];?></h6>
                  </li>
                  <li class="mb20-sm">
                    <p class="text mb5">Date</p>
                    <h6 class="mb-0"><?php echo $rs['bkgdate'];?></h6>
                  </li>
                  <li class="mb20-sm">
                    <p class="text mb5">Total</p>
                    <h6 class="mb-0"><?php echo $rs['price'];?></h6>
                  </li>
                  <li>
              ...
              <div class="">
                     <button type="submit" name="submit"> <a class="ud-btn btn-thm" href="user.php">Click to continue<i class="fal fa-arrow-right-long"></i></a></button>
                    </div>
            </div>            
          </div>
        </div>
