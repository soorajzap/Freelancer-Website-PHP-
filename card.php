    ...
    if(isset($_POST['submit']))
{
  ...
  $cn=$_POST['cn'];
  $n=mysqli_query ($con,"update booking set pstatus='paid',cn='$cn' where bkgno='$g'");
session_start();
$_SESSION['bno']=$g;
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cuname" class="form-control" value=<?php echo $rs['cuname'];?> />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <label>Total payable amount <?php echo $rs['price'];?></label>
