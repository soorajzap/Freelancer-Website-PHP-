        ...
        <div class="row align-items-center justify-content-between">
          ...
          <div class="col-auto">
            <div class="d-flex align-items-center">
              ...
              <a class="login-info mx15-lg mx30" href="userdash.php"><span class="d-none d-xl-inline-block">Dashboard </span> </a>
                ...
                <div class="tab-pane fade" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                  <div class="testimonial-style2 at-about2 text-center">
                    <div class="testi-content text-center">
                      ...
                      <h4 class="testi-text">"Great customer service makes life easier for everyone."</h4>
                    </div>
                  </div>
                </div>
