...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-dashboard-add-service.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2023 04:53:55 GMT -->
<head>
<meta charset="utf-8">
...
<?php
    ...
    if(isset($_POST['submit']))
    {
      ...
      $munm=$_SESSION['uname'];
      $dup=mysqli_query($con,"select * from freelance where uname='$munm' and titile='$titile'");
      $dupres=mysqli_fetch_array($dup);
      if(empty($dupres[0]))
      {
        move_uploaded_file($_FILES['file']["tmp_name"],"img/".$_FILES['file']["name"]);
      $photo="img/".$_FILES['file']["name"];
      $n=mysqli_query ($con,"insert into freelance(titile,price,times,category,skill,description,photo,uname) values(' $titile','$price','$times','$cat','$skill','$dis','$photo','$munm')");
      if($n>0)
      {
        echo "<script>alert('Service created successfully');window.location.href='sellerpage.php';</script>";     
      }
      }
      else
      {
        echo "<script>alert('Invalid');window.location.href='gigs.php';</script>";    
      }
    ...
    <div class="dashboard dashboard_wrapper pr30 pr0-xl">
      <div class="dashboard__sidebar d-none d-lg-block">
        <div class="dashboard_sidebar_list">
          ...
          <div class="sidebar_list_item ">
            <a href="gigs.php" class="items-center -is-active"><i class="flaticon-presentation mr15"></i>Manage Services</a>
          </div>
            ...
            <div class="col-xl-12">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="mb20">
                          ...
                          <input type="text" class="form-control" placeholder="i will" name="titile">
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="mb20">
                          <label class="heading-color ff-heading fw500 mb10">Price</label>
                          <input type="text" class="form-control" placeholder="$10" name="price">
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="mb20">
                      ...
                      <div class="col-sm-6">
                        <div class="mb20">
                          <div class="form-style1">
                            ...
                            <div class="bootselect-multiselect">
                              <select class="selectpicker"   name="times">
                                <option>Select</option>
                                <option value="Delivery Time One">Delivery Time One</option>
                                <option value="Delivery Time Two">Delivery Time Two</option>
                                <option value="Delivery Time Three">Delivery Time Three</option>
                              </select>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-md-12">
                        <div class="mb10">
                          ...
                          <textarea cols="30" rows="6" placeholder="Description" type="text"  name="description" required></textarea>
                        </div>
                      </div>
              ...
              <div class="ps-widget bgc-white bdrs12 p30 mb30 overflow-hidden position-relative">
                ...
                <div class="col-xl-9">
                  ...
                  <input type="file" placeholder="Enter your photo" name="file" required>
                  </div>
                  <button class="ud-btn btn-thm" type="submit" name="submit">submit<i class="fal fa-arrow-right-long"></i></button>
                </div>
              </div>
            </div>
          </div>
...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-dashboard-add-service.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2023 04:53:57 GMT -->
</html>