...
session_start();
$s=$_SESSION['uname'];
$data=mysqli_query($con,"select * from booking where pstatus='paid' and sstatus='accepted' and suname='$s'");
    ...
    <div class="dashboard dashboard_wrapper pr30 pr0-xl">
      <div class="dashboard__sidebar d-none d-lg-block">
        <div class="dashboard_sidebar_list">
          ...
          <div class="sidebar_list_item ">
            <a href="profile.php" class="items-center"><i class="flaticon-photo mr15"></i>My Profile</a>
          </div>
          <div class="sidebar_list_item ">
        ...
        <div class="dashboard__content hover-bgc-color">
          ...
          <div class="row">
            <div class="col-xl-12">
              ...
              <td class="vam"><span class="pending-style style1"><a href="sub.php?id=<?php echo $res['bkgno'];?>"><b>Submission</a></span>
              </td>
