...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-dashboard-reviews.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2023 04:53:55 GMT -->
<head>
<meta charset="utf-8">
...
session_start();
$s=$_SESSION['uname'];
$data=mysqli_query($con,"select * from booking where pstatus='paid' and sstatus='completed' and suname='$s'");
?>
<body>
<div class="wrapper">
    ...
    <div class="dashboard dashboard_wrapper pr30 pr0-xl">
      <div class="dashboard__sidebar d-none d-lg-block">
        <div class="dashboard_sidebar_list">
          ...
          <div class="sidebar_list_item ">
            <a href="sellerreview.php" class="items-center  -is-active"><i class="flaticon-review-1 mr15"></i>Feedback</a>
          </div>
          <div class="sidebar_list_item">
              ...
              <div class="dashboard_navigationbar d-block d-lg-none">
                <div class="dropdown">
                  ...
                  <ul id="myDropdown" class="dropdown-content">
                    ...
                    <li class="active"><a href="page-dashboard-reviews.html"><i class="flaticon-review-1 mr10"></i>Reviews</a></li>
                  ...
                  <div class="navtab-style1">
                    <nav>
                      <div class="nav nav-tabs mb20" id="nav-tab2" role="tablist">
                        <button class="nav-link active fw500 ps-0" id="nav-item1-tab" data-bs-toggle="tab" data-bs-target="#nav-item1" type="button" role="tab" aria-controls="nav-item1" aria-selected="true">Services</button>
                          </div>  
                          <?php
...
?>                 
                            <div class="col-md-12">
                             ...
                             <h6 class="mt-0 mb-1"><?php echo $res['cuname'];?></h6>
                             <div class="d-flex align-items-center">
                          <div><i class="fas fa-star vam fz10 review-color me-2"></i><span class="fz15 fw500"><b>Order ID:</b><?php echo $res['bkgno'];?></span></div>
                        <div class="ms-3"><span class="fz14 text"><?php echo $res['bkgdate'];?></span></div>
                       </div>
                      </div>
                     </div>
                     <div class="mb15">
                <label class="form-label fw600 dark-color"><p class="text mt20 mb20"></p></label>
                <input type="text" class="form-control" placeholder="<?php echo $res['fdback'];?>">
              </div>
