...
<?php
      ...
      if($opword==$g)
   {
      if($npword==$rpword)
       {
      $n=mysqli_query ($con,"update free set pword='$npword' where uname='$u'");
      echo "<script>alert('Password changed');window.location.href='homepage.php';</script>";
       }
      else
        {
      echo "<script>alert('Password not changed');window.location.href='homepage.php';</script>";
        }
        }
      else
        {
       echo "<script>alert('Old password is incorrect');window.location.href='homepage.php';</script>";
        }
        ...
        <div class="row wow fadeInRight" data-wow-delay="300ms">
          <div class="col-xl-6 mx-auto">
            ...
            <div class="log-reg-form search-modal form-style1 bgc-white p50 p30-sm default-box-shadow1 bdrs12">
              ...
              <div class="mb15">
                <label class="form-label fw500 dark-color"> Old Password</label>
                <input type="text" class="form-control" placeholder="*******" name="opword">
              </div>
              <div class="mb15">
                <label class="form-label fw500 dark-color">New Password</label>
                <input type="text" class="form-control" placeholder="*******" name="npword">
              </div>
              <div class="mb15">
                <label class="form-label fw500 dark-color">Confirm Password</label>
                <input type="text" class="form-control" placeholder="*******" name="rpword">
              </div>
              <div class="d-grid mb20">
                <button class="ud-btn btn-thm default-box-shadow2" type="submit" name="submit">change password<i class="fal fa-arrow-right-long"></i></button>
              </div>
