...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-dashboard-statement.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2023 04:53:55 GMT -->
<head>
<meta charset="utf-8">
...
$data=mysqli_query($con,"select * from booking where  sstatus='completed'");
    ...
    <div class="dashboard dashboard_wrapper pr30 pr0-xl">
      <div class="dashboard__sidebar d-none d-lg-block">
        <div class="dashboard_sidebar_list">
          ...
          <div class="sidebar_list_item ">
            <a href="ahistory.php" class="items-center -is-active"><i class="flaticon-chat mr15"></i>Order History</a>
          </div>
          <div class="sidebar_list_item ">
              ...
              <div class="dashboard_navigationbar d-block d-lg-none">
                <div class="dropdown">
                  ...
                  <ul id="myDropdown" class="dropdown-content">
                    ...
                    <li class="active"><a href="page-dashboard-statement.html"><i class="flaticon-web mr10"></i>Statements</a></li>
