...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-dashboard-manage-jobs.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2023 04:53:58 GMT -->
<head>
<meta charset="utf-8">
...
$munm=$_SESSION['uname'];
$_SESSION['m']=0;
$data=mysqli_query($con,"select * from freelance where uname='$munm'");
?>
<body>
<div class="wrapper">
    ...
    <div class="dashboard dashboard_wrapper pr30 pr0-xl">
      <div class="dashboard__sidebar d-none d-lg-block">
        <div class="dashboard_sidebar_list">
          ...
          <div class="sidebar_list_item">
            <a href="gigss.php" class="items-center -is-active"><i class="flaticon-document mr15"></i>Services</a>
          </div>
              ...
              <div class="dashboard_navigationbar d-block d-lg-none">
                <div class="dropdown">
                  ...
                  <ul id="myDropdown" class="dropdown-content">
                    ...
                    <li class="active"><a href="page-dashboard-manage-jobs.html"><i class="flaticon-briefcase mr10"></i>Manage Jobs</a></li>
                          ...
                          <div class="freelancer-style1 p-0 mb-0 box-shadow-none">
                            <div class="d-lg-flex align-items-lg-center">
                              <div class="thumb w60 position-relative rounded-circle mb15-md">
                                <img class="rounded-circle mx-auto" alt="">
                                <span class="online-badge2"></span>
                              </div>
                              <div class="details ml15 ml0-md mb15-md">
                                <h5 class="title mb-2"><?php echo $res['titile'];?></h5>
                               
                              </div>
                            </div>
                          </div>
                        </th>
                        <td class="vam"><span class="fz15 fw400"><?php echo $res['description'];?></span></td>

                        <td>
                          <div class="d-flex">
                            <a href="editservice.php?id=<?php echo $res['titile'];?>" class="icon me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><span class="flaticon-pencil"></span></a>
                            <a href="delete.php?id=<?php echo $res['titile'];?>" class="icon" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"><span class="flaticon-delete"></span></a>
                          </div>
                        </td>
                      </tr>
                    <?php
