...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-become-seller.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2023 04:53:59 GMT -->
<head>
<meta charset="utf-8">
        ...
        <div class="row align-items-center justify-content-between">
          ...
          <div class="col-auto">
            <div class="d-flex align-items-center">
              ...
              <ul id="respMenu" class="ace-responsive-menu" data-menu-style="horizontal">
                ...
                <li class="visible_list"> <a class="list-item" href="#"><span class="title">Users</span></a>
                  <ul>
                    ...
                    <li> <a href="seller.php"><span class="title">Become Seller</span></a></li>
                  </ul>
                </li>
              ...
              <a class="login-info mx15-lg mx30" href="seller.php"><span class="d-none d-xl-inline-block">Become a</span> Seller</a>
              <a class="login-info mr15-lg mr30" href="login.php">Sign in</a>
              <a class="ud-btn btn-thm add-joining" href="reg.php">Join</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <ul>
        ...
        <li><span>Users</span>
          <ul>
            ...
            <li><a href="seller.php">Become Seller</a></li>
          </ul>
        </li>
        <li><span>Pages</span>
          <ul>
          ...
          <div class="row">
            <div class="col-xl-5">
              <div class="position-relative wow fadeInUp" data-wow-delay="300ms">
                ...
                <a class="ud-btn btn-thm" href="seller.php">Become Seller<i class="fal fa-arrow-right-long"></i></a>
              </div>
            </div>
          </div>
        </div>
...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-become-seller.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2023 04:54:02 GMT -->
</html>