...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-dashboard-add-service.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2023 15:48:34 GMT -->
<head>
<meta charset="utf-8">
...
$d=$_SESSION['uname'];
$n=mysqli_query($con,"select * from freelance where titile='$id' and uname='$d'");
          ...
          <div class="row pb40">
            ...
            <div class="col-lg-3">
              <div class="text-lg-end">
                <a href="#" class="ud-btn btn-dark">Edit & Publish<i class="fal fa-arrow-right-long"></i></a>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-xl-12">
              <div class="ps-widget bgc-white bdrs4 p30 mb30 overflow-hidden position-relative">
                <div class="bdrb1 pb15 mb25">
                  <h5 class="list-title">Edit Information</h5>
                </div>
                <div class="col-xl-8">
                <form method="post" enctype="multipart/form-data">
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="mb20">
                          <label class="heading-color ff-heading fw500 mb10">Edit Price</label>
                          <input type="text" class="form-control"  name="price" value="<?php echo $result['price'];?>" required>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="mb10">
                          <label class="heading-color ff-heading fw500 mb10">Edit Services Detail</label>
                          <input cols="30" rows="6" type="text" class="form-control"  name="description" value="<?php echo $result['description'];?>" required>
                        </div>
                      </div>
...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-dashboard-add-service.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2023 15:48:36 GMT -->
</html>