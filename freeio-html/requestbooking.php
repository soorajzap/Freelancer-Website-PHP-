...
session_start();
$s=$_SESSION['uname'];
$data=mysqli_query($con,"select * from booking where pstatus='newreq' and sstatus='newreq' and suname='$s'");
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                      <div class="user_setting_content">
                        ...
                        <a class="dropdown-item active" href="page-dashboard-payouts.html"><i class="flaticon-dollar mr10"></i>Payouts</a>
    ...
    <div class="dashboard dashboard_wrapper pr30 pr0-xl">
      <div class="dashboard__sidebar d-none d-lg-block">
        <div class="dashboard_sidebar_list">
          ...
          <div class="sidebar_list_item">
            <a href="page-dashboard-payouts.html" class="items-center -is-active"><i class="flaticon-dollar mr15"></i>Payouts</a>
          </div>
          <div class="sidebar_list_item">
              ...
              <div class="dashboard_navigationbar d-block d-lg-none">
                <div class="dropdown">
                  ...
                  <ul id="myDropdown" class="dropdown-content">
                    ...
                    <li class="active"><a href="page-dashboard-payouts.html"><i class="flaticon-dollar mr10"></i>Payouts</a></li>
          ...
          <div class="row align-items-center justify-content-between pb40">
            ...
            <div class="col-lg-6">
              <div class="text-lg-end">
                <a href="paymentdone.php" class="ud-btn btn-dark default-box-shadow2"> Payment done<i class="fal fa-arrow-right-long"></i></a>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-xl-12">
              ...
              <td class="vam"><span class="pending-style style1"><a href="acorder.php?id=<?php echo $res['bkgno'];?>"><b>Accept</a></span>
              </td>
              <td class="vam"><span class="pending-style style1"><a href="rejorder.php?id=<?php echo $res['bkgno'];?>"><b>Reject</a></span>
