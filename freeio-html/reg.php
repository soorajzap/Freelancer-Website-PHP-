...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2023 04:51:28 GMT -->
<head>
<meta charset="utf-8">
...
<?php
    ...
    if(isset($_POST['submit']))
    {
      ...
      $mno=$_POST['no'];
      $mpword=$_POST['pword'];
      $dup=mysqli_query($con,"select * from free where uname='$munm'");
      $dupres=mysqli_fetch_array($dup);
      if(empty($dupres[0]))
      {
      $n=mysqli_query ($con,"insert into free(name,uname,emails,number,pword,rights) values(' $mnm','$munm','$mem','$mno','$mpword','user')");
      if($n>0)
      {
        echo "<script>alert('Registration sucess');window.location.href='Homepage.php';</script>";     
      }
      }
      else
      {
        echo "<script>alert('Duplication');window.location.href='Homepage.php';</script>";    
      }
          ...
          <div class="col-xl-6 mx-auto">
            ...
            <div class="log-reg-form search-modal form-style1 bgc-white p50 p30-sm default-box-shadow1 bdrs12">
              ...
              <div class="mb25">
                ...
                <input type="text" class="form-control" placeholder="uname" name="unm">
              </div>
              <div class="mb25">
                <label class="form-label fw500 dark-color">Email</label>
                <input type="email" class="form-control" placeholder="gmail" name="em">
              </div>
              <div class="mb25">
                <label class="form-label fw500 dark-color">Mobno</label>
                <input type="text" class="form-control" placeholder="Mobnumber" name="no">
              </div>
              <div class="mb15">
              ...
              <div class="d-grid mb20">
                <button class="ud-btn btn-thm default-box-shadow2" type="submit" name="submit">Creat Account <i class="fal fa-arrow-right-long"></i></button>
              </div>
...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2023 04:51:59 GMT -->
</html>