...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-dashboard-proposal.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2023 15:48:32 GMT -->
<head>
<meta charset="utf-8">
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                      <div class="user_setting_content">
                        ...
                        <a class="dropdown-item active" href="page-dashboard-proposal.html"><i class="flaticon-document mr10"></i>My Proposals</a>
    ...
    <div class="dashboard dashboard_wrapper pr30 pr0-xl">
      <div class="dashboard__sidebar d-none d-lg-block">
        <div class="dashboard_sidebar_list">
          ...
          <div class="sidebar_list_item">
            <a href="page-dashboard-proposal.html" class="items-center -is-active"><i class="flaticon-document mr15"></i>My Proposals</a>
          </div>
          <div class="sidebar_list_item">
...
?>
                      <tr>
                        ...
                        <td class="vam"><h5 class="mb-0"><?php echo $res['description'];?><span class="fz14 fw400"></span></h5></td>
                        <td>
                        <div class="d-flex">
                          </td>
                          
                          <td><a href="editservice.php?id=<?php echo $res['titile'];?>"><b>edit</a></td>
                          <td><a href="delete.php?id=<?php echo $res['titile'];?>"><b>delete</a></td>
                          </div>
                        </td>
                      </tr>
                      <?php
