...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2023 04:54:27 GMT -->
<head>
<meta charset="utf-8">
...
if(isset($_POST['submit']))
{
  $munm=$_POST['unm'];
  $mpword=$_POST['pword'];
  $user1=mysqli_query($con,"select * from free where uname='$munm' and pword='$mpword'");
        ...
        <div class="row align-items-center justify-content-between">
          ...
          <div class="col-auto">
            <div class="d-flex align-items-center">
              ...
              <ul id="respMenu" class="ace-responsive-menu" data-menu-style="horizontal">
                ...
                <li class="visible_list"> <a class="list-item" href="#"><span class="title">Users</span></a>
                  <ul>
                    ...
                    <li> <a href="sellerreq.php"><span class="title">Become Seller</span></a></li>
                  </ul>
                </li>
              ...
              <a class="login-info mr15-lg mr30" href="reg.php">Sign in</a>
              <a class="ud-btn btn-thm add-joining" href="login.php">Join</a>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-xl-6 mx-auto">
            ...
            <div class="log-reg-form search-modal form-style1 bgc-white p50 p30-sm default-box-shadow1 bdrs12">
              <div class="mb30">
                ...
                <p class="text">Don't have an account? <a href="reg.php" class="text-thm">Sign Up!</a></p>
              </div>
              <div class="mb20">
              ...
              <div class="d-grid mb20">
                <button class="ud-btn btn-thm" type="submit" name="submit">Log In <i class="fal fa-arrow-right-long"></i></button>
              </div>
