...
$n=mysqli_query($con,"select * from booking where sstatus='completed'");
$tot=mysqli_num_rows($n);

$no=mysqli_query($con,"select * from booking where sstatus='accepted'");
          ...
          <div class="col-6 col-lg-auto">
            <div class="text-center text-lg-start d-flex align-items-center">
              <div class="dashboard_header_logo position-relative me-2 me-xl-5">
                <a href="Homepage.php" class="logo"><img src="images/header-logo-dark.svg" alt=""></a>
              </div>
              <div class="fz20 ml90">
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                      <div class="user_setting_content">
                        ...
                        <a class="dropdown-item active" href="userdash.php"><i class="flaticon-home mr10"></i>Dashboard</a>
                        <a class="dropdown-item" href="userproposal.php"><i class="flaticon-document mr10"></i>Seller req</a>
                        ...
                        <a class="dropdown-item" href="sellerreview.php"><i class="flaticon-review-1 mr10"></i>Feedback</a>
                        <a class="dropdown-item" href="History.php"><i class="flaticon-receipt mr10"></i>History</a>
                        <a class="dropdown-item" href="page-dashboard-payouts.html"><i class="flaticon-dollar mr10"></i></a>
                        <a class="dropdown-item" href="statement.php"><i class="flaticon-web mr10"></i>Statements</a>
