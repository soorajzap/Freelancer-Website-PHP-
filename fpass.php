        ...
        <div class="row wow fadeInRight" data-wow-delay="300ms">
          <div class="col-xl-6 mx-auto">
            ...
            <div class="log-reg-form search-modal form-style1 bgc-white p50 p30-sm default-box-shadow1 bdrs12">
              ...
              <div class="mb15">
                <label class="form-label fw600 dark-color">Mob no</label>
                <input type="text" class="form-control" placeholder="Mob no" name="mbno" requird>
              </div>
             
                <button class="ud-btn btn-thm" type="submit" name="submit">SEND<i class="fal fa-arrow-right-long"></i></button>
              </div>
