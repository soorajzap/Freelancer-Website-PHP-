...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-dashboard-proposal.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2023 04:53:53 GMT -->
<head>
<meta charset="utf-8">
...
$data=mysqli_query($con,"select * from free where rights='new seller'");
?>
<body>
<div class="wrapper">
          ...
          <ul>
            <li><span>Dashboard</span>
              <ul>
                ...
                <li><a href="request.php">Proposal</a></li>
      ...
      <div class="dashboard__sidebar d-none d-lg-block">
        <div class="dashboard_sidebar_list">
          ...
          <div class="sidebar_list_item">
            <a href="Admindash.php" class="items-center "><i class="flaticon-home mr15"></i>Dashboard</a>
          </div>
          <div class="sidebar_list_item">
            <a href="request.php" class="items-center -is-active"><i class="flaticon-document mr15"></i>Seller Request</a>
          </div>
          <div class="sidebar_list_item">
              ...
              <div class="dashboard_navigationbar d-block d-lg-none">
                <div class="dropdown">
                  ...
                  <ul id="myDropdown" class="dropdown-content">
                    ...
                    <li class="active"><a href="page-dashboard-proposal.html"><i class="flaticon-document mr10"></i>My Proposals</a></li>
                          ...
                          <div class="freelancer-style1 p-0 mb-0 box-shadow-none">
                            <div class="d-lg-flex align-items-lg-center">
                              ...
                              <div class="details ml15 ml0-md mb15-md">
                                <h5 class="title mb-2"><?php echo $res['name'];?></h5>
                                <p class="mb-0 fz14 list-inline-item mb5-sm pe-1"><i class="flaticon-place fz16 vam text-thm2 me-1"></i></p>
                                <p class="mb-0 fz14 list-inline-item mb5-sm pe-1"><i class="flaticon-30-days fz16 vam text-thm2 me-1 bdrl1 pl15 pl0-xs bdrn-xs"></i></p>
                                <p class="mb-0 fz14 list-inline-item mb5-sm"><i class="flaticon-contract fz16 vam text-thm2 me-1 bdrl1 pl15 pl0-xs bdrn-xs"></i></p>
                              </div>
                            </div>
                          </div>
                        </th>
                        <td class="vam"><h5 class="mb-0"><?php echo $res['emails'];?><span class="fz14 fw400"></span></h5></td>
                        <td>
                          <div class="d-flex">
                          </td>
              <td><a href="accept.php?id=<?php echo $res['uname'];?>"><b>accept</a>
              </td>
              <td><a href="reject.php?id=<?php echo $res['uname'];?>"><b>reject</a>
              </td>
                          </div>
                        </td>
                      </tr>
...
?>
                  ...
                  <div class="mbp_pagination text-center mt30">
                    ...
                    <p class="mt10 mb-0 pagination_page_count text-center"> </p>
                  </div>
                </div>
              </div>
            </div>
