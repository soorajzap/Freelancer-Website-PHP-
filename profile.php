...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-dashboard-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2023 04:53:58 GMT -->
<head>
<meta charset="utf-8">
...
<?php
   ...
   if(isset($_POST['submit']))
   {
    ...
    $n=mysqli_query($con,"insert into profile(name,emails,phno,tag,gen,spec,con,city,lan,level,intro,skill,photo) values('$name','$emails','$phno','$tag','$gen','$spec','$cont','$city','$lan','$level','$intro','$skill','$photo')");
    if($n>0)
    {
      echo "<script>alert('profile created');window.location.href='sellerpage.php';</script>";     
    }
    else
    {
      echo "<script>alert('Invalid');window.location.href='sellerpage.php';</script>";    
    }
    }
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                      <div class="user_setting_content">
                        ...
                        <a class="dropdown-item" href="gigs.html"><i class="flaticon-presentation mr10"></i>Manage Services</a>
          ...
          <div class="row">
            <div class="col-xl-12">
              <div class="ps-widget bgc-white bdrs4 p30 mb30 overflow-hidden position-relative">
                ...
                <div class="col-lg-7">
                  <form class="form-style1" method="POST" enctype="multipart/form-data">
                  <div class="col-xl-7">
                  <div class="profile-box d-sm-flex align-items-center mb30">
                    <div class="profile-img mb20-sm">
                      <img class="w-100 rounded-circle wa-xs" src="images/team/fl-1.png" alt="">
                    </div>
                    <div class="form-group">
                            <input type="file" class="form-input" name="file" id="photo" placeholder="Profile picture" />
                        </div>
                    </div>
                  </div>
                </div>
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="mb20">
                          ...
                          <input type="text" class="form-control" placeholder="phno"  name="phno">
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="mb20">
                          <label class="heading-color ff-heading fw500 mb10">Tagline</label>
                      ...
                      <div class="col-sm-6">
                        <div class="mb20">
                          <label class="heading-color ff-heading fw500 mb10">Specializaion</label>
                      ...
                      <div class="col-sm-6">
                        <div class="mb20">
                          ...
                          <input type="text" class="form-control" placeholder="Country"  name="con">
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="mb20">
                      ...
                      <div class="col-sm-6">
                        <div class="mb20">
                          <div class="form-style1">
                            ...
                            <div class="bootselect-multiselect">
                              <select class="selectpicker"  name="lan" multiple>
                      ...
                      <div class="col-md-12">
                        <div class="mb10">
                          ...
                          <textarea cols="30" rows="6" type="text" placeholder="Description"  name="intro"></textarea>
                        </div>
                      </div>
