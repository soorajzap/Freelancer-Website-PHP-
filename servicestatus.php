...
<?php
    ...
    $data=mysqli_query($con,"select * from booking where title='$id'");
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                      <div class="user_setting_content">
                        ...
                        <a class="dropdown-item active" href="page-dashboard-payouts.html"><i class="flaticon-dollar mr10"></i>Service status</a>
          ...
          <ul>
            <li><span>Dashboard</span>
              <ul>
                ...
                <li><a href="page-dashboard-payouts.html">Service status</a></li>
    ...
    <div class="dashboard dashboard_wrapper pr30 pr0-xl">
      <div class="dashboard__sidebar d-none d-lg-block">
        <div class="dashboard_sidebar_list">
          ...
          <div class="sidebar_list_item">
            <a href="page-dashboard-payouts.html" class="items-center -is-active"><i class="flaticon-dollar mr15"></i>Service status</a>
          </div>
          <div class="sidebar_list_item">
              ...
              <div class="dashboard_navigationbar d-block d-lg-none">
                <div class="dropdown">
                  ...
                  <ul id="myDropdown" class="dropdown-content">
                    ...
                    <li class="active"><a href="page-dashboard-payouts.html"><i class="flaticon-dollar mr10"></i>Service status</a></li>
            ...
            <div class="col-xl-12">
                ...
                <div class="packages_table table-responsive">
                  <table class="table-style3 table at-savesearch">
                    ...
                    while($result=mysqli_fetch_array($data))
                      ...
                      <span><?php echo $result['cuname'];?></span>
                      </tr>
              ...
              ?>
                      <tr>
                        ...
                        <td class="vam">Payoneer</td>
                        <td class="vam"><span class="pending-style style2">Completed</span></td>
                      </tr>
                      <tr>
                        <th class="active">$1.800</th>
                        <td class="vam">April 9, 2023</td>
                        <td class="vam">Bank Transfer</td>
                        <td class="vam"><span class="pending-style style2">Completed</span></td>
                      </tr>
                      <tr>
                        <th scope="row">$1.800</th>
              ...
              <div class="ps-widget bgc-white bdrs4 p30 mb30 position-relative">
                <div class="row">
                  <div class="col-lg-9">
                    ...
                    <h5 class="mb15">Service status</h5>
